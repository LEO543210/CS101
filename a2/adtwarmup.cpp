...
STUDENT_TEST("duplicateNegatives, input has only one negatives") {
    Queue<int> q = {-3};
...
STUDENT_TEST("duplicateNegatives, negative is in the front to check wheather the loop will show up.") {
    Queue<int> q = {-3, 2};
    Queue<int> expected = {-3, -3, 2};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}

STUDENT_TEST("duplicateNegatives, negative is in the back to check wheather the loop will show up.") {
    Queue<int> q = {3, -2};
    Queue<int> expected = {3, -2, -2};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}

STUDENT_TEST("duplicateNegatives, negative is in the front and back to check wheather the loop will show up.") {
    Queue<int> q = {-2, 3, -2};
    Queue<int> expected = {-2, -2, 3, -2, -2};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}

STUDENT_TEST("duplicateNegatives, only negetives.") {
    Queue<int> q = {-2, -3, -2};
    Queue<int> expected = {-2, -2, -3, -3, -2, -2};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}

STUDENT_TEST("duplicateNegatives, only one positive.") {
    Queue<int> q = {2};
    Queue<int> expected = {2};
